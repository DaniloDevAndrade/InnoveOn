          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-8 w-8 rounded-lg">
                <AvatarImage src={user.avatar} alt={user.nameUser} />
                <AvatarFallback className="rounded-lg"><User></User></AvatarFallback>
              </Avatar>
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-semibold">{user.nameUser}</span>
                <span className="truncate text-xs">{user.emailUser}</span>
              </div>
