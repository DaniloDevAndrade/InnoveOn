      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="flex flex-col items-center justify-center text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
            NOSSAS <span className="text-emerald-400">SOLUÇÕES</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
            Tecnologia de ponta para impulsionar seu negócio ao próximo nível
          </p>
          <div className="mt-8 max-w-4xl mx-auto">
            <p className="text-gray-300 text-lg">
              Na InnoveON, desenvolvemos soluções tecnológicas personalizadas que transformam desafios em oportunidades.
              Combinamos expertise técnica, visão estratégica e metodologias ágeis para entregar resultados que fazem a
              diferença para seu negócio.
            </p>
          </div>
          <div className="mt-12 flex flex-wrap justify-center gap-4">
            ...
            <button onClick={openContactModal} className="border border-emerald-500 text-emerald-400 hover:bg-emerald-500/10 font-medium py-3 px-8 rounded-xl transition-colors">
