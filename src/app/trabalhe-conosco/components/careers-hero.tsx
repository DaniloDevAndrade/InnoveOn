...
export default function CareersHero() {
  ...
  useEffect(() => {
    ...
    // Função para atualizar a posição e propriedades das estrelas
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="flex flex-col items-center justify-center text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
            TRABALHE <span className="text-emerald-400">CONOSCO</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
            Junte-se ao time que está transformando o futuro digital
          </p>

          <div className="mt-8 max-w-4xl mx-auto">
            <p className="text-gray-300 text-lg">
              Na InnoveON, acreditamos que pessoas extraordinárias criam soluções extraordinárias. Estamos sempre em
              busca de talentos apaixonados por tecnologia, inovação e que queiram fazer a diferença em um ambiente
